                ...
                <div className="p-8 bg-gray-700 border border-gray-500 rounded">
                    ...
                    <form onSubmit={handleSubscribe} className="flex flex-col gap-2 w-full">
                        ...
                        <button 
                         type="submit"
                         disabled={loading}
                         className='mt-4 bg-blue-700 uppercase py-4 rounded font-bold text-sm hover:bg-purple-500-200 hover:text-gray-700 transitions-colors disabled:opacity-80'
                         >  
                            Garantir minha vaga
                        </button>
                    </form>
